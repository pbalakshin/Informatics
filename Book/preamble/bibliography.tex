...
% ГОСТ 7.1-2003, ГОСТ 7.0.5-2008: библиографическая запись и ссылки
...
\usepackage[
    ...
    autolang=other,
    movenames=false,
    sorting=ntvy,% Сортировка: имя-год-заголовок (требование ГОСТ)
...
\DeclareFieldFormat{urldate}{%
    \mkbibparens{Дата обращения\addcolon\space#1}%
}
...
% Сделаем ссылки URL нормальным шрифтом
