...
\begin{minipage}[l]{9cm}
    ...
    %\hhline{~--------}
    \multicolumn{5}{c}{} & \multicolumn{4}{c}{$\underbrace{\qquad \qquad \qquad \qquad \qquad \qquad \qquad}_{\text{от N штук (от 00..0 }}$} \\ % chktex 9
...
\begin{xltabular}{\textwidth}{|c|c|c|c|c|X|X|}
    ...
    $F$ & 0 & 1 & 1 & 0 & $F_{2,6} = x \oplus y = \allowbreak x \text{ XOR } y = \allowbreak \text{XOR}(x,y) = \allowbreak x >< y = \allowbreak x <> y = \allowbreak x \text{ NE } y = \allowbreak \text{NE}(x,y)$ & Сложение по модулю 2, исключающее \enquote{или}, сумма Жегалкина, не равно \\ \hline
...
\begin{table}[H]
    \caption{Таблица значений и названий булевых функций от двух переменных}s
    \centering
    \footnotesize
