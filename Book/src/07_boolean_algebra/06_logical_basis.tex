...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
         ...
         ``НЕ'' & $ \overline{x} = \overline{x \ast 1} = \overline{x \ast x} $ &  \makecell*{\includegraphics{not-and-basis/not-all}} \\ \hline
         ``ИЛИ'' & $ x_0 + x_1 = \overline{\overline{x_0} \ast \overline{x_1}} $  & \makecell*{\includegraphics{not-and-basis/or}} \\ \hline
         ``И'' & $ x_0 \ast x_1 = \overline{\overline{x_0 \ast x_1}} $ & \makecell*{\includegraphics{not-and-basis/and}} \\ \hline
    \end{tabular}
    }
    \caption{Пример реализации функций И, ИЛИ, НЕ в базисе ``И-НЕ''}
...
\begin{figure}[H]
    \includegraphics[width=.3\textwidth]{not-and-basis/not0} \hfill
    \includegraphics[width=.3\textwidth]{not-and-basis/not1} \hfill
    \includegraphics[width=.3\textwidth]{not-and-basis/not2}
\end{figure}

\paragraph{Пример реализации функции ``ИЛИ`` в базисе ``И-НЕ''}
Формула: $ x_0 + x_1 = \overline{\overline{x_0} \ast \overline{x_1}} $ \\
\includegraphics[width=.5\textwidth]{not-and-basis/or}

\paragraph{Пример реализации функции ``И`` в базисе ``И-НЕ''}
Формула: $ x_0 \ast x_1 = \overline{\overline{x_0 \ast x_1}} $ \\
\includegraphics[width=.5\textwidth]{not-and-basis/and}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{infix}
