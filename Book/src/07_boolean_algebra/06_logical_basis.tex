...
\begin{table}[H]
    ...
    \caption{Пример реализации функций И, ИЛИ, НЕ в базисе ``И-НЕ''}\label{tab:not-and-basis-examples}
\end{table}

\paragraph{Пример реализации функции ``НЕ'' в базисе ``И-НЕ''}\label{par:not-and-basis-not}
...
\paragraph{Пример реализации функции ``ИЛИ'' в базисе ``И-НЕ''}\label{par:not-and-basis-or}
...
\paragraph{Пример реализации функции ``И'' в базисе ``И-НЕ''}\label{par:not-and-basis-and}
