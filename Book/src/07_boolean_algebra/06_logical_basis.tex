...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|c|c|c|}
            ...
            \enquote{НЕ} & $ \overline{x} = \overline{x \ast 1} = \overline{x \ast x} $ &  \makecell*{\includegraphics{7.5-nand-basis-not}} \\ \hline
            \enquote{ИЛИ} & $ x_0 + x_1 = \overline{\overline{x_0} \ast \overline{x_1}} $  & \makecell*{\includegraphics{7.5-nand-basis-or}} \\ \hline
            \enquote{И} & $ x_0 \ast x_1 = \overline{\overline{x_0 \ast x_1}} $ & \makecell*{\includegraphics{7.5-nand-basis-and}} \\ \hline
        \end{tabular}
    }
    \caption{Пример реализации функций И, ИЛИ, НЕ в базисе \enquote{И-НЕ}}\label{tab:not-and-basis-examples}
\end{table}

\paragraph{Пример реализации функции \enquote{НЕ} в базисе \enquote{И-НЕ}}\label{par:not-and-basis-not}
...
\paragraph{Пример реализации функции \enquote{ИЛИ} в базисе \enquote{И-НЕ}}\label{par:not-and-basis-or}
...
\paragraph{Пример реализации функции \enquote{И} в базисе \enquote{И-НЕ}}\label{par:not-and-basis-and}
