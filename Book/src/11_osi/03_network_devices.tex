% !TeX root = ../../main.tex
\subsection{Сетевые устройства}\label{subsec:network-devices}
...
\paragraph{Сравнение коммутатора и маршрутизатора}\label{par:switch-vs-router}

\begin{table}[H]
    \centering
    \caption{Сравнение коммутатора и маршрутизатора}\label{tab:switch-vs-router}
