...
\begin{example}
    \task%
    Составить код Хаффмана для неоптимальных префиксных кодов для последовательности AAABCCCCCDEEEF. Найти среднюю длину кодового слова.

    \solution%
    Составим список свободных узлов для исходной последовательности:
    \begin{table}[H]
        \centering
    ...
    \[
        1 \times \frac{5}{14} + 2 \times \frac{3}{14} + 3 \times \frac{3}{14} + 4 \times \frac{1}{14} + 5 \times \frac{1}{14} + 5 \times \frac{1}{14} = \frac{34}{14} \approx \num{2.4}
    \]
\end{example}
...
\begin{example}
    ...
    Средняя длина кодового слова:
    \[
        2 \times \frac{5}{14} + 2 \times \frac{3}{14} + 2 \times \frac{3}{14} + 3 \times \frac{1}{14} + 4 \times \frac{1}{14} + 4 \times \frac{1}{14} = \frac{33}{14} \approx \num{2.35}
    \]
\end{example}
