...
% \sisetup{
%     % Разделители
%     decimal-marker = {,},      % Запятая для десятичных
%     group-separator = {\,},    % Тонкий пробел для тысяч
%     group-minimum-digits = 4,  % Разделять группы от 4 цифр

%     % Единицы измерения
%     per-mode = symbol,         % м/с вместо м⋅с⁻¹
%     range-phrase = {--},       % Тире для диапазонов
%     range-units = repeat,      % Повторять единицы: 1 м -- 5 м

%     % Шрифты
%     number-math-rm = \rmfamily,
%     unit-math-rm = \rmfamily,
% }
